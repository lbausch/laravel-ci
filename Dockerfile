...
# Install PHP
RUN apt-get update && apt-get install -y php8.0-fpm php8.0-bcmath php8.0-cli php8.0-curl php8.0-ldap php8.0-mysql php8.0-mbstring php8.0-dom php8.0-xdebug php8.0-tidy php8.0-gd php8.0-zip php8.0-imap php8.0-soap php8.0-sqlite php-redis && \
    php -m && \
    php -v
