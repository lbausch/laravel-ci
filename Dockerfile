...
# Install PHP
RUN apt-get update && apt-get install -y php8.1-fpm php8.1-bcmath php8.1-cli php8.1-curl php8.1-ldap php8.1-mysql php8.1-mbstring php8.1-dom php8.1-xdebug php8.1-tidy php8.1-gd php8.1-zip php8.1-imap php8.1-soap php8.1-sqlite php-redis && \
    php -m && \
    php -v
