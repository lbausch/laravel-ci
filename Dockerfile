...
# Install PHP
RUN apt-get update && apt-get install -y php7.4-fpm php7.4-bcmath php7.4-cli php7.4-curl php7.4-gmp php7.4-mysql php7.4-mbstring php7.4-dom php7.4-xdebug php7.4-tidy php7.4-gd php7.4-zip php7.4-imap php7.4-soap php7.4-sqlite && \
    php -m && \
    php -v
